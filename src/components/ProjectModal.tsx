        ...
        <div className="mt-8 border-t border-border pt-6">
          ...
          {project.notionUrl &&
              <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-7 sm:mt-0 sm:ml-6  inline-flex items-center gap-2 rounded-full bg-primary px-5 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-primary/90">
